         ...
         BoundsSymmetry,enterBoundsManually,alpha,spendingFunctionUsed)
{
  ...
  #Set Toplevel
  outTask3Toplevel <- tktoplevel()
  tkwm.title(outTask3Toplevel,paste("-3-    n=",n," ,drift parameter=",round(drift,digits=5)))
  ...
  onShowGraph <- function()
  {
    ## if one-Sided-Test we won´t see negative Z-Values
      if(BoundsSymmetry==1)
      {
        ...
        plot(xCoordinate,yCoordinate,main=paste("-3-  ,n=",n,"  ,drift=",round(drift,digits=5),"  ,",FunctionNames[spendingFunctionUsed[1]]),
      ...
      else
      {
        ...
        ## first plotting bounds as points...
        plot(xCoordinate,yCoordinate,main=paste("-3-  ,n=",n,"  ,drift=",round(drift,digits=5),
                                                "  ,upper=",FunctionNames[spendingFunctionUsed[1]],
                                                " ,lower=",FunctionNames[spendingFunctionUsed[2]]),
             pch=21,bg="green",font=4,font.axis=4,font.lab=4,font.main=4,
