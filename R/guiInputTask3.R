...
tkgrid.remove(listOfTimePointLabel.secondTimes[[i]],listOfEntries.secondTimes[[i]])
  ...
  OnCalculateInputTask1 <- function()
  {
    ...
    {
      calculateTask3(n,nMax,t,t2,t2max,t3,drift,equallySpacedTimesInput,secondTimeScaleIsUsedInput, BoundsSymmetry, c(alpha1,alpha2),
...
#######################################################################################################  
  ...
  calculate.button <-tkbutton(task3,text=" CALCULATE ",command=OnCalculateInputTask1)
